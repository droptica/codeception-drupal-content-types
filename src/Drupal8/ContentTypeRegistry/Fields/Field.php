...
namespace Codeception\Module\Drupal8\ContentTypeRegistry\Fields;

use Codeception\Exception\ConfigurationException as ConfigurationException;
use Codeception\Lib\Interfaces\Web;
use Codeception\Util\Debug;
use Codeception\Module\Drupal8\ContentTypeRegistry\Widgets\Widget;

/**
 * Class Field
 *
 * @package Codeception\Module\Drupal8\ContentTypeRegistry\Fields
 */
class Field {
  /**
  ...
  /**
   * Field widget Machine name.
   *
   * @var string
   */
  protected $widgetMachineName;
  ...
  /**
   * Gets machine name of field widget.
   *
   * @return string
   */
  public function getWidgetMachineName() {
    return $this->widgetMachineName;
  }

  /**
   * Sets field widget machine name.
   *
   * @param string $widgetMachineName
   */
  public function setWidgetMachineName($widgetMachineName) {
    $this->widgetMachineName = $widgetMachineName;
  }
  ...
  public static function parseYaml($yaml) {
    ...
    if (isset($yaml['type'])) {
      ...
      $field->setWidgetMachineName($yaml['widget']);
    ...
    if (isset($yaml['cardinality'])) {
      $field->setCardinality($yaml['cardinality']);
    }
