...
use Codeception\Module\Drupal8\ContentTypeRegistry\ContentType;
use Codeception\Module\Drupal8\ContentTypeRegistry\Fields\Field;
use Codeception\Module\Drupal8\ContentTypeRegistry\ContentTypeRegistryStorageInterface;
use Codeception\Module\Drupal8\ContentTypeRegistry\ContentTypeRegistryYamlStorage;
use Codeception\Lib\Interfaces\Web as WebInterface;
use InvalidArgumentException;
use Codeception\Util\Debug;

/**
 * Class DrupalContentTypeRegistryD8
 * @package Codeception\Module
 */
class DrupalContentTypeRegistryD8 extends Module
{
  /**
